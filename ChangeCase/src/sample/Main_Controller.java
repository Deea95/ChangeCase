    ...
    private void changeTheme(Event event) {
        switch (counter) {
            case 0:
                ...
                changeStylesheets("/sample/dark-theme.css", event);
                break;
            case 1:
                System.out.println("blue");
                changeStylesheets("/sample/blue-theme.css", event);
                break;
            case 2:
                System.out.println("green");
                changeStylesheets("/sample/green-theme.css", event);
                break;
            case 3:
                System.out.println("red");
                changeStylesheets("/sample/red-theme.css", event);
                break;
        }
        counter = ++counter % 4;
    }
